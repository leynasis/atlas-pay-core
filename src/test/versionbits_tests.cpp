...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    for (const auto& chain_name : {CBaseChainParams::MAIN, CBaseChainParams::TESTNET, CBaseChainParams::DEVNET, CBaseChainParams::REGTEST}) {
        const auto chainParams = CreateChainParams(chain_name == CBaseChainParams::DEVNET ? lave_args : *m_node.args, chain_name);
